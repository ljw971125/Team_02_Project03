...
<p style="margin-left: 20px;">
    ...
    <span style="margin-left: 300px; font-size: larger;">주차공간이 협소합니다. 가능한 한 대중교통을 이용해주세요</span><br>
    <span style="margin-left: 310px; font-size: larger;">주차가 꼭 필요하신 경우는 하루 전에 연락해 주시기 바랍니다.</span><br>
    <span style="margin-left: 310px; font-size: larger;">문의 : 010-1234-5678</span><br>
</p>
</div>
</article>
