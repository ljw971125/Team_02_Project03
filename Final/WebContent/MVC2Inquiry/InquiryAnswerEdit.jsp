...
<jsp:include page="/Common/header.jsp" />  <!-- 공통 링크 -->
  ...
  <form name="writeFrm" method="post" 
      action="../mvc2/answeredit.do" onsubmit="return validateForm(this);">
      <input type="hidden" name="num" value="${ dto.num }"/>
<table class="table table-striped-columns table-success 
    				table-bordered border-dark table-hover" >
    <tr>
        <td>
            <textarea class="form-control" placeholder="답변을 입력해주세요." name="icomment" style="width:90%;height:100px;">${ dto.icomment }</textarea>
        </td>
