...
<table class="table table-striped-columns table-success 
    ...
    <tr>
        <td>
            <input type="text" class="form-control" placeholder="제목을 입력해주세요." name="title" style="width:90%;" value="${ dto.title }" />
        </td>
    </tr>
    <tr>
        <td>
            <textarea class="form-control" placeholder="내용을 입력해주세요." name="icontent" style="width:90%;height:100px;">${ dto.icontent }</textarea>
        </td>
