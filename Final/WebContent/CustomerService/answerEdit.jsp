...
<h2><a href="<%=request.getContextPath() %>/CustomerService/InquiryMain.jsp" class="my_inquiry">문의 게시판</a> - 답변수정하기(Comment)</h2>
<article>
	<form name="writeFrm" method="post" action="answerEditProcess.jsp"
	    ...
	    <table class="table table-striped-columns table-success 
	        ...
	        <tr>
	            <td>내용</td>
	            <td>
	                <textarea class="form-control" placeholder="내용을 입력해주세요." name="icomment" style="width: 90%; height: 100px;"><%= dto.getIcomment() %></textarea>
	            </td>
	        </tr>
	        <tr>
