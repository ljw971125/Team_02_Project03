...
<h2><a href="<%=request.getContextPath() %>/CustomerService/InquiryMain.jsp" class="my_inquiry">문의 게시판</a> - 수정하기(Edit)</h2>
	...
	<form name="writeFrm" method="post" action="EditProcess.jsp"
	    ...
	    <table class="table table-striped-columns table-success 
	        ...
	        <tr>
	            <td>내용</td>
	            <td>
	                <textarea class="form-control" placeholder="내용을 입력해주세요." name="content" style="width: 90%; height: 100px;"><%= dto.getIcontent() %></textarea>
	            </td>
	        </tr>
	        <tr>
